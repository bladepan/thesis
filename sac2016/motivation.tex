...
using a server-centric approach: [references elided] %~\cite{tilothesis,EdwardsBack:csc2011}:
...
present, in which their actions took immediate effect [reference elided].%~\cite{BaileyBack:igi2013}.
