...
% ----------------------------------------------------------------------------------------------
\subsection{Chat Application w/ AngularJS}
...
A second example of a disproportionate impact on specific implementation limitations
is the handling of styles.  For instance, jQuery's \code{toggle()} changes an element's
...
is the original implementation of a frequently called function \emph{lengthFromProperties}
