...
API objects are implemented using a proxy design pattern~\cite{GangOfFour}:  
...
% Even if we used hidden non-enumerable property
% the application code can still guess the property name.

% \cite http://javascript.crockford.com/private.html
