...
% ------ made a section of impl... : secure access to system object
% ------ namespace based, carefully control objects app can access
% ------ the access is made by place the object into the global name
