...
\item[singleInstancePerUser] 
    ...
    for each user.
    The instantiation mode  requires authentication to establish a user identity. 
...
the existence of \appins{}s and virtual browsers is not exposed to the end user as
