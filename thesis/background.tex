...
if a \cb is deployed at \emph{example.com} and an application's mount point is
\emph{/chat}, the user could access the application at \emph{http://example.com/chat}.
