...
To balance requests evenly across the web servers, a load balancer
...
%
% I would just discuss a few options for sharing and synchronizing access to
% session state in a cluster: central database, redis, memcached, Tomcat session replication, etc.
%
