...
\newcommand{\nodrmimethodinvokefig}{
    ...
    The stub object stubB represents objB on Process B.
    nodermi constructs a method invocation message and sends the message
    to Process B.
    The message contains the encoding of the parameter of this method call,
    a function named \emph{callback} on Process A.
    The Process B decodes the message, 
    creates a stub object represents the function \emph{callback} and pass the stub object
    to objB.
    }
