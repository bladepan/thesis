...
\newcommand{\nodermiobjmapfig}{
    \begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{../figs/nodermi_objectmap}
...
\newcommand{\nodermipassbyreffig}{
    \begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{../figs/nodermi_passstubbyreference}
    ...
    remote reference for the argument's source object.}
...
\newcommand{\nodrmipassbyvalfig}{
    \begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{../figs/nodermi_passbyvalue2}
    \caption[Passing arguments by value in remote method invocations]
    {Passing arguments by value in remote method invocations: \code{objB} is a \code{Date}
    object. When it is passed to a remote method, the receiving process creates an exact copy of 
    \code{objB}.}
...
\newcommand{\nodrmicyclefig}{
    \begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{../figs/nodermi_cycle}
