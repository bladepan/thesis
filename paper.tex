...
\newcommand{\cbtwo}{CloudBrowser 2.0}
...
\newcommand{\chatappfig}{
    ...
    \caption{Chat Application \\ Use App Instance to maintain shared 
    model object ChatRoom. Each virtual browser keeps a reference to the shared object.
    }
    \label{fig:chatapp}
    \end{figure}
}
